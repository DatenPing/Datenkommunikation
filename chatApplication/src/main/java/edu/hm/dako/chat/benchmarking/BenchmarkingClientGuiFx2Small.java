...
public class BenchmarkingClientGuiFx2Small extends Application
	...
	private final static int TEXTFIELDFONTSIZE = 10;
	...
	private final static int LABELFIELDFONTSIZE = 10;
	...
	private Pane createInputPane() {
		...
		textFieldNumberOfClientThreads.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldNumberOfMessagesPerClients.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldNumberOfMaxRetries.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldMessageLength.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldResponseTimeout.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldThinkTime.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldServerport.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldServerIpAdress.setFont(Font.font(TEXTFIELDFONTSIZE));
	...
	private Pane createRunTimePane() {
		...
		textFieldPlannedRequests.setFont(Font.font(TEXTFIELDFONTSIZE));

		runTimePane.add(createLabel("Gesendete Requests"), 5, 1);
		textFieldSentRequests = createNotEditableTextfield(runTimePane, 7, 1);
		textFieldSentRequests.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldPlannedEventMessages.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldSentEventMessages.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldRetriedEvents.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldReceivedConfirmEvents.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldLostConfirmEvents.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldNumberOfRetries.setFont(Font.font(TEXTFIELDFONTSIZE));
	...
	private Pane createResultPane() {
		...
		textFieldInterquartilRange.setFont(Font.font(TEXTFIELDFONTSIZE));

		resultPane.add(createLabel("Spannweite in ms"), 5, 3);
		textFieldRange = createNotEditableTextfield(resultPane, 7, 3);
		textFieldRange.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldAvgServerTime.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldMaxHeapUsage.setFont(Font.font(TEXTFIELDFONTSIZE));
		...
		textFieldAvgCpuUsage.setFont(Font.font(TEXTFIELDFONTSIZE));
	...
	private Label createLabel(String value) {
		...
		label.setFont(Font.font(LABELFIELDFONTSIZE));
	...
	private ProgressBar createProgressbar() {
		...
		progressBar.setMinSize(1050, 30);
		progressBar.setMaxSize(1050, 30);
