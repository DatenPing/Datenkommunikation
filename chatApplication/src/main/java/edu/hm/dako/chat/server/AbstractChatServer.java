...
public abstract class AbstractChatServer implements ChatServerInterface {
    ...
    /**
     * Erzeugt den zur Bearbeitung der Anfrage notwendigen WorkerThread.
     *
     * @param connection die für den workerThread notwendigeb Verbindungsinformationen
     * @return einen neuen WorkerThread zur Bearbeitung
     */
    protected abstract AbstractWorkerThread getWorkerThreadImpl(Connection connection);
}
